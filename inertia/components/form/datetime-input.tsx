...
import { Calendar03FreeIcons } from '@hugeicons/core-free-icons';
...
import { CheckIcon, ChevronDownIcon, ChevronLeftIcon, ChevronRightIcon, ChevronUpIcon, Clock, XCircle } from 'lucide-react';
...
export function DateTimePicker({
    ...
    const dislayFormat = useMemo(() => {
        if (!displayValue) return 'DD/MM/YYYY';
        return format(
            displayValue,
                ...
                <Popover open={open} onOpenChange={setOpen} modal={modal}>
                    <PopoverTrigger asChild>
                        {renderTrigger ? (
                            ...
                            <div
                                className={cn(
                                    'flex h-9 w-full cursor-pointer items-center rounded-md border border-input pe-1 ps-3 text-sm font-normal shadow-xs data-[state=open]:border data-[state=open]:border-blue-500 data-[state=open]:outline-3 data-[state=open]:outline-blue-500/20 data-[state=open]:ring-0',
                    ...
                    <PopoverContent className="w-auto px-0 py-0">
                        <div className="flex items-center justify-between border-b border-b-slate-100 px-4 py-2">
                            <div className="text-md ms-2 flex cursor-pointer select-none items-center font-bold">
                                <div>
                                    <span
                                        onClick={() =>
                                            setMonthYearPicker(
                                        ...
                                        className={
                                            'cursor-pointer border-b-transparent hover:border-b hover:border-dotted hover:border-blue-400'
                                        }
                                    >
                                ...
                                <Button
                                    variant="ghost"
                                    size="icon"
                                    className={'ms-2 rounded-full p-0'}
                                    onClick={() =>
                                        setMonthYearPicker(
                        ...
                        <div className="relative overflow-hidden p-4">
                            <DayPicker
                                ...
                                classNames={{
                                    ...
                                    day: 'h-10 gap-2 w-10 text-center text-sm p-0 relative flex items-center justify-center [&:has([aria-selected].day-range-end)]:rounded-r-md [&:has([aria-selected].day-outside)]:bg-accent/50 [&:has([aria-selected])]:bg-accent first:[&:has([aria-selected])]:rounded-l-md last:[&:has([aria-selected])]:rounded-r-md focus-within:relative focus-within:z-20 rounded-1',
                                    day_button: cn(
                                        buttonVariants({ variant: 'ghost' }),
                                        'size-9 rounded-full hover:border transition-all duration-200 hover:bg-blue-300 hover:border-blue-500 p-0 font-normal aria-selected:opacity-100',
                                    ),
                                    range_end: 'day-range-end',
                                    selected:
                                        'bg-blue-300 border border-blue-500 transition-all rounded-full text-blue-600 font-medium hover:text-primary-foreground focus:bg-primary focus:text-primary-foreground',
                        ...
                        <div className="flex flex-col gap-2 p-4">
                            ...
                            <div className="flex items-center justify-between gap-2">
                                ...
                                <Button
                                    ...
                                    onClick={onSubmit}
                                    className={
                                        'w-full bg-blue-500 text-white hover:bg-blue-600 hover:text-white focus:bg-blue-600'
                                    }
                                >
                                    Pilih
                                </Button>
        ...
        <div className={'grid gap-1.5'}>
            ...
            <Drawer open={open} onOpenChange={setOpen} modal={modal}>
                ...
                <DrawerContent className={'w-full'}>
                    <div className="flex items-center justify-between border-b border-b-slate-100 px-4 py-4">
                        <div className="text-md ms-2 flex cursor-pointer select-none items-center font-bold">
                            <div>
                                <span
                                    onClick={() =>
...
function MonthYearPicker({
    ...
    const months = useMemo(() => {
        ...
        for (let i = 0; i < 12; i++) {
            ...
            months.push({
                value: i,
                label: new Date(0, i).toLocaleString('id', {
                    month: 'short',
                }),
                disabled,
            });
                        ...
                        {years.map((year) => (
                            ...
                            >
                                <Button
                                    ...
                                    className="rounded-md hover:bg-slate-200 focus:bg-slate-200"
